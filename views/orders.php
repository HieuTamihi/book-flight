        ...
        <div class="card">
            <div class="card-header">
                <div class="card-tools">
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addOD"><i class="fas fa-plus"></i> ADD</button>
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="GET" action="result.php">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light small" placeholder="Search for fullname..." aria-label="Search" aria-describedby="basic-addon2" name="keyword" size="30">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        $total = count($getAllOrder);
                        // // lấy đường dẫn đến file hiện hành
                        $url = $_SERVER['PHP_SELF'] . "?page=" . $page;
                        $orderPaginate = $order->orderPaginate($page, $perPage);
                            ...
                            <tr>
                                ...
                                <td class="project-state">
                                    <?php if ($value['status'] == '0') {
                                        echo '<span style="color:red;"> Chưa Liên Hệ </span>';
                                    } else {
                                        echo '<span style="color:green;"> Đã Liên Hệ </span>';
                                    } ?>
                                </td>
                                ...
                                <td class="project-actions text-right">
                                    ...
                                    <a class="btn btn-danger btn-sm"  href="../controllers/order/deleteOD.php?id=<?php echo $value['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">
...
<div class="modal fade" id="addOD" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="padding: 20px;">
            ...
            <form action="../controllers/order/addOD.php" method="post">
