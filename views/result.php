                ...
                <div class="card-tools">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="GET" action="">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" name="keyword">
                ...
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['keyword'])) :
                            ...
                            $search1 = $order->search1($keyword, $page, $perPage);
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-danger btn-sm" href="deleteOD.php?id=<?php echo $value['id']; ?>">
