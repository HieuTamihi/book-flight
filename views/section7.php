...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'fail') {
        echo "<script> alert('Xóa Thất Bại! Không thể xóa Main Title và Description được'); </script>";
    }
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Section 7 Management</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Section 7 Management</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-tools">
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#addSS7"><i class="fas fa-plus"></i> ADD</button>
                </div>
            </div>
            <!-- Topbar Search -->
                        ...
                        foreach ($getAllSection7 as $value) : ?>
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-primary btn-sm" href="editSection7.php?id=<?php echo $value['id']; ?>">
                                        <i class="fas fa-pencil-alt">
                                        </i>
                                        Edit
                                    </a>
                                    <?php if (count($getAllSection7) > 1) : ?>
                                        <a class="btn btn-danger btn-sm" href="../controllers/section7/deleteSS7.php?id=<?php echo $value['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">
    ...
    <!-- MODAL ADD SECTION 7 -->
    <!-- Modal -->
    <div class="modal fade" id="addSS7" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content" style="padding: 20px;">
                <div class="modal-header">
                    <h4 class="modal-title">ADD Section 7</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form action="../controllers/section7/addSS7.php" method="post" enctype="multipart/form-data">
                    <label for="inputStatus">Main Title</label>
                    <div class="input-group form-group">
                        <input type="text" class="form-control" placeholder="Enter main title..." name="main">
                    </div>
                    ...
                    <label for="inputStatus">Sub Content</label>
                    <div class="input-group form-group">
                        <input type="text" class="form-control" placeholder="Enter sub content..." name="sub_content" required>
                    </div>
